...
def get_nearest_restaurants(latitude, longitude, limit=8):
...
def index():
    ...
    if city_query:
        ...
        if coordinates:
            ...
            restaurants = get_nearest_restaurants(latitude, longitude, limit=8)
...
def restaurant_detail(res_id):
    ...
    return render_template("detail.html", restaurant=selected)
